...
Suppose you are selling lego technic sets with 2050+ peices on eBay. How do you keep track of all the parts? This app aims to simplify this process by allowing you to count the number of pieces in each individual section (whatever you define that to be!) and make sure all the totals match! 
